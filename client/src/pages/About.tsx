    ...
    <Card
      ...
      details={
        <>
          ...
          <p>
            My journey in coding and networking began in 1999, with my first introduction to Blizzard's Battle.Net service and <a href="https://us.shop.battle.net/en-us/family/starcraft-remastered" target="_blank" rel="noopener noreferrer">
            ...
            Game Maker</a>. Years later, between 2010 and 2013, I offered freelance web hosting services and learned a bit of C# inside of the <a href="https://unity.com/" rel="noopener noreferrer">
            Unity</a> video game engine. After my daughter was born I started a career in electronics manufacturing, but my passion for software never waned.
          </p>
          <p>
          ...
          <p>
            ...
            ESP32</a> microcontroller and learning C++. I also set up dual booting with <a href="https://www.linuxmint.com/" rel="noopener noreferrer">
            Linux Mint</a> and have been practicing the Linux workflow. I am always eager to learn new technologies and take on new challenges.
          </p>
          <p>
