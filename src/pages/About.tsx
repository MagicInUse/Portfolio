      ...
      details={
        <>
          <p>I like to code! I've been working with code since 2008! I'm now going through school to learn how to apply my skills in a professional setting.
              ...
              side of things, but I collaborate on hardware and software related code with my best friend <a href="https://github.com/JarenElectron">Jaren</a>.
          ...
          <p>In my free time I like to stream on <a href="https://www.twitch.tv/magicinuse">Twitch</a> and play guitar. Sometimes, both at the same time! That's through a game called <i>Rocksmith</i> which is like <i>Guitar Hero</i> but with a real guitar.
          </p>
        </>
      }
    />
